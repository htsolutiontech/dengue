...
class ChatBot:
    ...
    def main_window(self):
        ...
        self.window.title("ChatBot Dengue")
        ...
        self.tab.add(self.bot_frame,text='Doctor'.center(100))
    ...
    def add_bot(self):
        ...
        head_label=Label(self.bot_frame,bg=BG_COLOR,fg=TEXT_COLOR,text="ChatBotDengue",font=FONT_BOLD,pady=10)
    ...
    def on_enter(self,event):
        ...
        self.my_msg(msg,"Patient")
        self.bot_response(msg,"Assistant")
